...
export class CategoriasProvider {
  ...
  getcategorias(): Observable<Categoria[]> {
      return this._http.get('http://mylookxpressapp.com:8000/categoria/1')
      .map((response: Response) => <Categoria[]> response.json())

   }

  getsubcategorias(categoria): Observable<Subcategoria[]> {
      return this._http.get('http://mylookxpressapp.com:8000/subcategoria/'+categoria)
  ...
  getdistrito(): Observable<Distrito[]> {
      return this._http.get('http://mylookxpressapp.com:8000/distritos/')
